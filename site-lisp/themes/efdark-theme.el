;; This theme is a customized version the zerodark-theme:
;; https://github.com/NicolasPetton/zerodark-theme
;;
;; Shout out to @NicolasPetton for the great work
(deftheme efdark
...
(let ((class '((class color) (min-colors 89)))
      ...
      (string (if (true-color-p) "#81A1C1" "afafaf"))
      (light (if (true-color-p) "#d8dee9" "#d7d7d7"))
      ...
      (comment-delimiter (if (true-color-p) "#3c465a" "#707070"))
  ...
  (custom-theme-set-faces
   ...
   `(tree-sitter-hl-face:property ((,class (:background nil))))
   ...
   `(tree-sitter-hl-face:method.call ((,class (:inherit font-lock-function-name-face))))
   `(tree-sitter-hl-face:function.call ((,class (:inherit font-lock-function-name-face))))
   `(tree-sitter-hl-face:function.macro ((,class (:inherit font-lock-function-name-face))))
   `(tree-sitter-hl-face:attribute ((,class (:background nil :foreground ,default))))
   ...
   ;; macrostep
   `(macrostep-expansion-highlight-face ((,class (:background ,background-darker :extend t))))
   ...
   `(line-number-current-line ((,class (:foreground ,light :background ,background))))
   ...
   `(custom-group-tag ((,class (:foreground ,purple :weight bold :height 1.0))))
   ...
   `(magit-diff-removed-highlight ((,class (:inherit diff-removed :background ,background-red))))
   `(magit-diff-removed ((,class (:inherit diff-removed :background ,background-red))))
   `(magit-diff-added-highlight ((,class (:inherit diff-added :background ,background-green))))
   `(magit-diff-added ((,class (:inherit diff-added :background ,background-green))))
   ...
   `(flycheck-warning ((,class (:foreground ,orange :weight normal))))
   `(flycheck-error ((,class (:foreground ,red :weight bold))))
   `(flycheck-info ((,class (:foreground ,blue))))

   ;; flymake
   `(flymake-warning ((,class (:foreground ,orange :weight normal))))
   `(flymake-error ((,class (:foreground ,red :weight bold))))
   `(flymake-note ((,class (:foreground ,blue))))
   ...
   `(org-document-title ((,class (:foreground ,orange :height 1.0))))
   `(outline-1 ((,class (:foreground ,peach :weight bold :height 1.0))))
   `(outline-2 ((,class (:foreground ,purple :weight bold :height 1.0))))
   `(outline-3 ((,class (:foreground ,blue :weight bold :height 1.0))))
   ...
   `(helm-source-header ((,class (:height 1.0 :weight bold :foreground ,blue :background ,background-blue))))
