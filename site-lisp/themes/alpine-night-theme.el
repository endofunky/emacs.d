...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Org
   `(outline-1 ((,class (:foreground ,frost-2 :weight bold))))
   ...
   `(org-level-1 ((,class (:foreground ,frost-1))))
   `(org-level-2 ((,class (:foreground ,frost-2))))
   `(org-level-3 ((,class (:foreground ,frost-3))))
   `(org-level-4 ((,class (:foreground ,frost-4))))
   ...
   `(org-checkbox-statistics-todo ((,class (:foreground ,aurora-yellow))))
   ...
   `(org-todo ((,class (:foreground ,aurora-yellow :weight bold))))
   ...
   `(org-agenda-date-today ((,class (:foreground ,frost-2 :weight bold))))
   `(org-agenda-done ((,class (:foreground ,aurora-green))))
