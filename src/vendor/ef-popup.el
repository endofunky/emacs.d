...
`ef-popup-buffer-list' with any changes."
  (dolist (buf (cl-set-difference (ef-popup-buffers) ef-popup-buffer-list))
    (setq ef-popup-buffer-list (ef-popup-move-to-front buf ef-popup-buffer-list))))
...
(advice-add 'evil-window-rotate-downwards :around #'ef-popup-without-open-popup-ad)
(advice-add 'evil-window-rotate-upwards :around #'ef-popup-without-open-popup-ad)
